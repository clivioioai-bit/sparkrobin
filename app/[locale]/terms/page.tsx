...
export async function generateMetadata({
  ...
  let description = 'Read the Gemini Omni Flash terms of service for account use, AI video generation, credits, subscriptions, acceptable content, payments, refunds, and platform rules.'
  
  if (locale === 'ar') {
    title = 'شروط الخدمة | خدمة إنشاء فيديو AI'
    description = 'شروط الخدمة لخدمة إنشاء فيديو AI - اقرأ شروطنا وأحكامنا لاستخدام خدمة إنشاء فيديو AI.'
  } else if (locale === 'ja') {
    title = '利用規約 | AI動画生成サービス'
    description = 'AI動画生成サービスの利用規約 - AI動画生成サービスの使用に関する利用規約をお読みください。'
  }

  return {
    title,
    description,
    alternates: generateHreflangAlternates('/terms', locale),
    openGraph: {
      title,
      description,
...
const TermsOfService: React.FC<{ locale: string }> = ({ locale }) => {
  const prefix = locale === 'en' ? '' : `/${locale}`
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none">
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    For more information about our services, please visit our <a href={`${prefix}/`} className="text-primary hover:underline">homepage</a>, 
                    check out our <a href={`${prefix}/faq`} className="text-primary hover:underline">FAQ</a>, or review our 
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mt-4">
                    For more information, visit our <a href={`${prefix}/`} className="text-primary hover:underline">homepage</a>, 
                    <a href={`${prefix}/faq`} className="text-primary hover:underline"> FAQ</a>, or 
                    <a href={`${prefix}/privacy`} className="text-primary hover:underline"> Privacy Policy</a>.
                  </p>
                </section>
              </div>
