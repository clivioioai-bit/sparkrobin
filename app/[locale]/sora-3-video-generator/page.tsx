...
export async function generateMetadata({
  ...
  const title = 'Sora3 Видео-Генератор | AI Видео Без Водяных Знаков | sora3ai.io'
  const description = 'Создавайте короткие AI-видео в стиле Sora3: реклама, продукты, TikTok и контент для соцсетей. Без водяных знаков, быстро, дешево. Поддержка русского языка.'

  return {
    title,
    description,
    alternates: generateHreflangAlternates('/sora-3-video-generator', locale),
    openGraph: {
      title,
      description,
...
const features = [
  ...
  {
    icon: Clapperboard,
    title: '25с Sora3 Storyboard',
    description: 'Создавайте видео Sora3 Storyboard (мультисценовые) длительностью до 25 секунд. Идеально для рекламы, повествований и более длинного контента.',
    href: '/ru/sora-3-storyboard'
  },
]

export default async function Sora3VideoGeneratorPage({
  params
}: {
  params: Promise<{ locale: string }>
}) {
  ...
  const jsonLd = {
    ...
    '@type': 'WebPage',
    name: 'Sora3 Видео-Генератор',
    description: 'sora3ai.io — независимая платформа для создания AI-видео. Мы используем модели, совместимые с Sora3, для создания профессиональных видео без водяных знаков. Поддержка русского языка, оптимизация для рынка СНГ.',
    url: 'https://sora3ai.io/ru/sora-3-video-generator',
    mainEntity: {
      '@type': 'SoftwareApplication',
      name: 'Sora3 Видео-Генератор',
      applicationCategory: 'MultimediaApplication',
      operatingSystem: 'Web',
      description: 'Независимая платформа для создания AI-видео, предлагающая создание видео Sora3. sora3ai.io использует модели, совместимые с Sora, и другие сторонние движки AI-видео. sora3ai.io не связана с OpenAI, Google или Sora3.',
      offers: {
        '@type': 'Offer',
        price: '0',
        priceCurrency: 'USD',
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
                Sora3 Видео-Генератор Без Водяных Знаков
              </h1>
        ...
        {/* Why sora3ai.io Section */}
        <section className="py-16 sm:py-24 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Почему sora3ai.io лучший выбор для России и СНГ?
              </h2>
            </div>

            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="p-6 rounded-xl border border-border bg-card">
                <h3 className="text-xl font-semibold mb-3">1. Видео как у Sora3 — без водяных знаков</h3>
              ...
              <div className="p-6 rounded-xl border border-border bg-card">
                <h3 className="text-xl font-semibold mb-3">2. 10-секундные клипы + 25-секундный Storyboard</h3>
                <p className="text-muted-foreground mb-4">
                  Выберите формат:
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• <strong>10 секунд</strong> (быстрое поколение)</li>
                  <li>• <strong>25 секунд</strong> (сцены + переходы + сюжет)</li>
                </ul>
                <p className="text-sm text-muted-foreground mt-4">
                  Storyboard идеально подходит для рекламы, обзоров, интро, демонстрации продуктов.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-lg">Выберите «Клипы 10 секунд» или «Storyboard 25 секунд»</p>
                </div>
              </div>
              <div className="flex gap-4">
        ...
        <section className="py-16 sm:py-24 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Sora3 Видео-Генерация
              </h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Создавайте профессиональные видео Sora3 с помощью нашего мультимодельного конвейера генерации
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-6 rounded-xl bg-muted/50 border border-border">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                sora3ai.io — это независимая платформа для создания AI-видео. Мы используем модели, совместимые с Sora3, и другие сторонние модели для создания мультимодельной генерации видео. sora3ai.io не связана с OpenAI, Google или Sora3. Эта страница предназначена для помощи создателям в поиске инструментов генерации видео Sora3 и не является официальным сервисом Sora3.
              </p>
            </div>
          </div>
        </section>
