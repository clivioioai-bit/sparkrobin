...
export async function generateMetadata({
  ...
  if (locale === 'ar') {
    ...
    description = 'سياسة الخصوصية لخدمة إنشاء فيديو AI - تعرف على كيفية جمع واستخدام وحماية معلوماتك الشخصية.'
  } else if (locale === 'ja') {
    title = 'プライバシーポリシー | AI動画生成サービス'
    description = 'AI動画生成サービスのプライバシーポリシー - 個人情報の収集、使用、保護方法について学ぶ。'
  }
...
const PrivacyPolicy: React.FC<{ locale: string }> = ({ locale }) => {
  const prefix = locale === 'en' ? '' : `/${locale}`
              ...
              <div className="prose prose-lg max-w-none">
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    ...
                    <a href={`${prefix}/terms`} className="text-primary hover:underline"> Terms of Service</a>.
                  </p>
                </section>
