...
export async function generateMetadata({
  ...
  if (locale === 'ar') {
    ...
    description = 'سياسة الاسترداد لخدمة إنشاء فيديو AI - تعرف على سياسة الاسترداد الخاصة بنا للاعتمادات غير المستخدمة وشروط الخدمة.'
  } else if (locale === 'ja') {
    title = '返金ポリシー | AI動画生成サービス'
    description = 'AI動画生成サービスの返金ポリシー - 未使用のクレジットとサービス条件に関する返金ポリシーについて学ぶ。'
  }
...
const RefundPolicy: React.FC<{ locale: string }> = ({ locale }) => {
  const prefix = locale === 'en' ? '' : `/${locale}`
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mt-4">
                    ...
                    <a href={`${prefix}/faq`} className="text-primary hover:underline"> FAQ</a>, 
                    <a href={`${prefix}/terms`} className="text-primary hover:underline"> Terms of Service</a>, or 
                    <a href={`${prefix}/privacy`} className="text-primary hover:underline"> Privacy Policy</a>.
                  </p>
                </section>
