...
2. 点击"添加属性"
3. 选择"网址前缀"方式，输入：`https://sparkrobin.app`
...
1. 验证成功后，进入"索引" > "站点地图"
2. 点击"添加新的站点地图"
3. 输入：`https://sparkrobin.app/sitemap.xml`
4. 点击"提交"

### 步骤 4: 请求索引（可选）
1. 进入"网址检查"工具
2. 输入首页 URL：`https://sparkrobin.app`
3. 点击"请求编入索引"
...
部署后，检查以下 URL 是否可访问：
- ✅ `https://sparkrobin.app/sitemap.xml` - 应返回 XML 格式的网站地图
- ✅ `https://sparkrobin.app/robots.txt` - 应包含 sitemap 链接
