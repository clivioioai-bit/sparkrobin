    ...
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
          <div className="bg-card/30 backdrop-blur-xl rounded-lg p-4 text-center border border-border/50">
            <div className="flex items-center justify-center mb-2">
              <svg className="w-6 h-6 text-primary" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
              </svg>
            </div>
            <p className="text-sm font-medium text-foreground">{t('secureCheckout')}</p>
          </div>
          ...
          <div className="bg-card/30 backdrop-blur-xl rounded-lg p-4 text-center border border-border/50">
            ...
            <p className="text-sm font-medium text-foreground">{t('cancelAnytime')}</p>
          </div>
          ...
          <div className="bg-card/30 backdrop-blur-xl rounded-lg p-4 text-center border border-border/50">
            ...
            <p className="text-sm font-medium text-foreground">{t('noSurpriseCharges')}</p>
          </div>
          ...
          <div className="bg-card/30 backdrop-blur-xl rounded-lg p-4 text-center border border-border/50">
            ...
            <p className="text-sm font-medium text-foreground">{t('fastSupport')}</p>
          </div>
        </div>
      </div>
