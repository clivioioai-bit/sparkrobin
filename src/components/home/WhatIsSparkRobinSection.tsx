...
const points = [
  {
    ...
    description:
      "Spark Robin is still surrounded by speculation, so this site treats it as both a model to watch and a workflow to prepare for. The goal is to keep confirmed facts, assumptions, and practical creation steps separate.",
  },
  {
