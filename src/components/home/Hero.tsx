...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative h-screen flex items-center justify-center overflow-hidden bg-[#030712]"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 z-0" suppressHydrationWarning>
        ...
        {isMounted && !videoError && (
          ...
          >
            <source src="/videos/12月30日.mov" type="video/mp4" />
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#030712] via-transparent to-black/30" style={{ zIndex: 2 }} />
      </div>
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex flex-col justify-center">
        <div className="flex flex-col items-center space-y-6 sm:space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.08] backdrop-blur-sm border border-white/[0.12] text-white/80 text-xs sm:text-sm font-medium animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full max-w-md mx-auto pt-2">
            <Link href="/sora3-text-to-video" className="w-full sm:w-auto">
              <Button
                variant="hero"
                size="lg"
                className="w-full text-sm sm:text-base px-8 py-5 sm:py-6 !bg-white !text-[#030712] hover:!bg-white/90 hover:scale-[1.02] transition-all duration-300 font-semibold rounded-xl"
              >
            ...
            <Link href="/sora3-image-to-video" className="w-full sm:w-auto">
              <Button
                variant="outline"
                size="lg"
                className="w-full text-sm sm:text-base px-8 py-5 sm:py-6 bg-white/[0.06] backdrop-blur-sm border border-white/[0.15] text-white hover:bg-white/[0.12] hover:border-white/[0.25] hover:scale-[1.02] transition-all duration-300 font-medium rounded-xl"
              >
