...
// Wrapper component to use translations in class component
        ...
        <div className="text-center">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full bg-muted-foreground text-white px-4 py-2 rounded-md hover:bg-muted-foreground/90 transition-colors"
            >
              {t('goHome')}
            </button>
          </div>
