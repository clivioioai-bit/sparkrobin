          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
                Generate cinematic AI video with the latest Veo4 models. Text-to-video and image-to-video。
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0">
              <div className="flex items-center space-x-2 text-sm glass-effect rounded-lg px-3 py-2 hover-lift">
                ...
                <span className="font-medium">Veo4 Fast</span>
              </div>
              <div className="flex items-center space-x-2 text-sm glass-effect rounded-lg px-3 py-2 hover-lift">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button variant="hero" size="lg" className="group" onClick={() => (window.location.pathname = '/veo4-text-to-video')}>
