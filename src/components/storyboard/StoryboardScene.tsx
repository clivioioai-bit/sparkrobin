        ...
        {!isCollapsed && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium">{t('storyboard.shotDescription')}</Label>
              <Textarea
                placeholder={t('storyboard.shotDescriptionPlaceholder')}
                value={shot.prompt}
            ...
            {/* Duration Input */}
            <div className="space-y-2">
              <Label className="text-sm font-medium">{t('storyboard.duration')}</Label>
